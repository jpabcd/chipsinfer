...
CMD=(
  "$PYTHON_BIN" run_pipeline.py ls ../data/20260806/大图/S26C24136-08
  --batch-size 2
  --num-workers 8
  --persistent-workers
  --prefetch-factor 2
  ...
  --defect-report
  --defect-report-path "$OUTPUT_DIR/csv/S26C24136-08.csv"
  --external-xy-csv-path "../../48AMA/imgs/S26C24136-08/S26C24136-08.csv"
